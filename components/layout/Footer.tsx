  ...
  return (
    <footer className="bg-light-bg pt-16 pb-20 lg:pb-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
                ...
                <div className="relative w-40 h-12">
                  <Image 
                    src={settings.logo.desktop?.startsWith('http') 
                      ...
                      : `http://127.0.0.1:8000${settings.logo.desktop || settings.logo.mobile}`} 
            ...
            <p className="text-muted-text text-sm leading-relaxed">
              {settings?.company?.description || "Stylon is an Online Shop in BD. We provide high quality dress & Jewellery always."}
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-black">
              ...
              <li className="flex items-center gap-3">
                ...
                {settings?.company?.email || "stylonbd@gmail.com"}
              </li>
      ...
      <div className="bg-primary text-white text-center py-4 text-xs">
        <p>© 2026 {settings?.company?.name || "Stylon"} | Developed By Service Key.</p>
      </div>
    </footer>
  );
}
